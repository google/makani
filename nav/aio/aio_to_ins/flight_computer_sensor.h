...
#ifndef NAV_AIO_AIO_TO_INS_FLIGHT_COMPUTER_SENSOR_H_
#define NAV_AIO_AIO_TO_INS_FLIGHT_COMPUTER_SENSOR_H_
...
#endif  // NAV_AIO_AIO_TO_INS_FLIGHT_COMPUTER_SENSOR_H_
