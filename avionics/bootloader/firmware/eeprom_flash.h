...
#ifndef AVIONICS_BOOTLOADER_FIRMWARE_EEPROM_FLASH_H_
#define AVIONICS_BOOTLOADER_FIRMWARE_EEPROM_FLASH_H_
...
#endif  // AVIONICS_BOOTLOADER_FIRMWARE_EEPROM_FLASH_H_
