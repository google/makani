...
#ifndef AVIONICS_SHORT_STACK_FIRMWARE_OUTPUT_H_
#define AVIONICS_SHORT_STACK_FIRMWARE_OUTPUT_H_
...
// Regular status message for webmonitor and logs.
void ShortStackOutputSendStatusMessage(void);

#endif  // AVIONICS_SHORT_STACK_FIRMWARE_OUTPUT_H_
