...
#ifndef GS_MONITOR_LAYOUTS_LAYOUTS_CONTROLLER_H_
#define GS_MONITOR_LAYOUTS_LAYOUTS_CONTROLLER_H_
...
void ConfigFaultDetectionMonitor(GtkWidget *window, MonitorConfig *mconfig_out);
...
#endif  // GS_MONITOR_LAYOUTS_LAYOUTS_CONTROLLER_H_
