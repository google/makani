...
#ifndef CONTROL_ESTIMATOR_ESTIMATOR_TETHER_ANCHOR_H_
#define CONTROL_ESTIMATOR_ESTIMATOR_TETHER_ANCHOR_H_
...
#endif  // CONTROL_ESTIMATOR_ESTIMATOR_TETHER_ANCHOR_H_
