...
"""Servo MCP342X hardware monitor configuration."""
...
mcp342x_default = {
    ...
    'gain': mcp342x_types.kMcp342xGain8X,
}
...
rev_aa = [
    dict(ch1_pos, name='thermocouple_0', address=0x68),
    dict(ch2_pos, name='thermocouple_1', address=0x68),
]

mcp342x_config = (rev.ServoHardware, {
    rev.ServoHardware.REV_AA: rev_aa,
    rev.ServoHardware.REV_BA: rev_aa,  # No changes from rev_aa.
    rev.ServoHardware.REV_BB: rev_aa,  # No changes from rev_aa.
    rev.ServoHardware.REV_BC: rev_aa,  # No changes from rev_aa.
})
