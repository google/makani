...
#ifndef GS_STATE_COMMAND_WINCH_STATE_H_
#define GS_STATE_COMMAND_WINCH_STATE_H_
...
class WinchStateCommand : public StateCommandBase {
 public:
  WinchStateCommand(void) : StateCommandBase("Winch") {}
  ~WinchStateCommand(void) {}
...
#endif  // GS_STATE_COMMAND_WINCH_STATE_H_
