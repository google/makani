...
#ifndef GS_STATE_COMMAND_SERVO_STATE_H_
#define GS_STATE_COMMAND_SERVO_STATE_H_
...
class ServoStateCommand : public StateCommandBase {
 public:
  ServoStateCommand(void);
  ~ServoStateCommand(void) {}
 ...
 private:
  bool GetActuatorStateFromServoStatus(AioNode node, ActuatorState *state);
  bool GetActuatorStateFromTetherDown(ServoLabel label, ActuatorState *state);

  TetherDownMergeState tether_down_;
};

#endif  // GS_STATE_COMMAND_SERVO_STATE_H_
