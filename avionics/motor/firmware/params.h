...
#ifndef AVIONICS_MOTOR_FIRMWARE_PARAMS_H_
#define AVIONICS_MOTOR_FIRMWARE_PARAMS_H_
...
extern const MotorParams *g_motor_params;

#endif  // AVIONICS_MOTOR_FIRMWARE_PARAMS_H_
