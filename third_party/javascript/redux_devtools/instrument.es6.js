 ...
 *
 * @param {object} computedStates Computed states.
 * @param {int} minInvalidatedStateIndex Min invalidate state index.
 * @param {Function} reducer Reducer.
 * @param {object} committedState Committed state.
 * @param {object} actionsById Actions by id.
 * @param {object} stagedActionIds Staged action ids.
 * @param {object} skippedActionIds Skipped action ids.
 *
 * @returns {object} Computed states.
 */
 ...
 *
 * @param {Function} reducer Reducer.
 * @param {object} initialCommittedState Initial committed state.
 * @param {Function} monitorReducer Monitor reducer.
 * @param {object} options Options.
 *
 * @returns {Function} Lifted reducer.
 */
function liftReducerWith(reducer,
  ...
  return (liftedState = initialLiftedState, liftedAction) => {
    ...
    function commitExcessActions(n) {
      ...
      skippedActionIds =
        skippedActionIds.filter(id => idsToDelete.indexOf(id) === -1);
    ...
    switch (liftedAction.type) {
      ...
      case ActionTypes.SWEEP: {
        ...
        skippedActionIds = [];
        currentStateIndex =
          Math.min(currentStateIndex, stagedActionIds.length - 1);
        break;
      }
 ...
 *
 * @param {object} liftedState Lifted state.
 *
 * @returns {object} Unlifted state.
 */
 ...
 *
 * @param {object} liftedStore Lifted store.
 * @param {Function} liftReducer Lifted reducer.
 *
 * @returns {object} Unlifted store.
 */
